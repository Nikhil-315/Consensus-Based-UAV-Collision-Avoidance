...
class WaypointFollower:
    def __init__(self, agent_id, csv_file, cooperative):
        ...
        self.drone2_position_sub = rospy.Subscriber('/drone1/mavros/global_position/global', NavSatFix, self.drone2_position_callback)
        self.drone2_cooperative_sub = rospy.Subscriber('/drone1/cooperative', Int32, self.drone2_cooperative_callback)
        ...
        self.drone2_velocity_sub = rospy.Subscriber('/drone1/mavros/local_position/velocity_local', TwistStamped, self.drone2_velocity_callback)
    ...
    def check_collision(self):
        ...
        if self.drone1_velocity and self.drone2_velocity:
            ...
            if relative_distance > 0 and relative_velocity > 0:
                ...
                t= math.sqrt(dist**2 + relative_distance**2) / relative_velocity
                ...
                if dist < self.safe_dist and costheta > 0:
                    ...
                    vel_des= relative_distance/(math.cos(math.atan(self.safe_dist/relative_distance)) * t)
                    vel_req= math.sqrt(vel_des**2 - relative_velocity**2) * v_coeff

                    mag= math.sqrt(relative_velocity_vect[0]**2 + relative_velocity_vect[1]**2)

                    v= (-(vel_req * relative_velocity_vect[1])/mag, vel_req * relative_velocity_vect[0]/mag, 0)
                    ...
                    costheta = ((relative_distance_vect[0] * v_new1[0]) +
...
if __name__ == '__main__':
    ...
    csv_file = '/home/martian/ak_ws/src/collision_avoidance/src/waypoints.csv'  # Change this to your CSV file path
